...
import Pattern from "../../public/luckypattern.webp";
import {BookButton} from "../BookButton";

export const FinalCTA = () => {
    return (
        <Box component='section' sx={{ backgroundImage: `url('${Pattern.src}')`, backgroundSize: '200px', backgroundAttachment: 'fixed'}} px={4} py={8}>
