...
const BookSVGButton = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 286.723 287.416">
            ...
            <text transform="translate(143.361 133.708)" fill="#fff" fontSize="18" fontFamily="roc-grotesk"><tspan x="-60.029" y="0">BOOK A FREE</tspan><tspan x="-68.515" y="22">CONSULTATION</tspan></text>
        </svg>
    )
}
