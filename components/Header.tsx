    ...
    return (
        <motion.div initial={{opacity: 0, y: -80}} animate={{opacity: 1, y: 0, transition: {duration: 0.8}}}>
            <Link href='/contact' passHref>
                <Box sx={styles}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 286.723 289">
                        <g transform='translate(0, -20px)'>
                            <g id="booksvg1">
                        ...
                        <text transform="translate(150.361 133.708)" fill={isFooter ? '#000' : "#fff"} fontSize="24" fontFamily="roc-grotesk,sans-serif">
                            <tspan x="-60.029" y="0" >ENQUIRE</tspan>
                            <tspan x="-40.515" y="30">NOW</tspan></text>
                    </svg>
                </Box>
            </Link>
        </motion.div>
