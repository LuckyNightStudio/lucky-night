...
const styles = {
    p: 4, flex: 1, maxWidth: 200, minWidth: 130,
    '.imgStar': {
        transition: '0.4s',
    },
    '&:hover .imgStar': {
...
const SVGImage = ( { imgLink }: {imgLink: string}) => (
    <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 0 237.408 237.982" width="100%" height="100%">
        <defs>
            <pattern id={imgLink} preserveAspectRatio="xMidYMid slice" width="100%" height="100%" viewBox="0 0 1772 1772">
                <image width="1772" height="1772" xlinkHref={imgLink}/>
            </pattern>
        </defs>
        <g>
...
interface Props {
    links: { text: string, img: string }[]
}

export const StarLinks = ({links}: Props) => {
    return (
        <Box>
            <Container>
                <Box textAlign='center' mx={2} mt={2}>
                    <Typography style={{ display: 'inline-block'}} variant='h3' component='h1' m={4}>
                        Digital Design
                        <span style={{...underlineStyle, background: theme.palette.yellowDarker.main}} />
                    </Typography>
