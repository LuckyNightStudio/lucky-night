    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.552 101.292">
            <g transform="translate(-536.224 -3991.214)">
                ...
                <text transform="translate(588 4052.146)" fontSize="40" fontFamily="roc-grotesk,sans-serif"><tspan x="-11.123" y="0">{++index}</tspan></text>
            </g>
        </svg>
    )
}
        ...
        <Box component='section' px={4} py={10} position='relative'>
            <Box sx={{ display: 'flex'}}>
                <Box flex={1} sx={{ position: 'relative', display: largerThanSM ? 'inline-block' : 'none' }}>
                    <Box sx={{ position: 'absolute', top: '2%', left: largerThanMD ? 30 : 0, width: '70%', transform: 'rotate(-16deg)', maxWidth: 280  }}>
                        <Laptop />
                    </Box>
                    <Box sx={{ position: 'absolute', top: extra ? '30%' : '50%', left: largerThanMD ? 30 : 0, width: '80%', maxWidth: 280 }}>
                        <Swatches />
                    </Box>
                    {extra && <Box sx={{position: 'absolute', bottom: '10%', left: largerThanMD ? 30 : 0, width: '80%', maxWidth: 280 }}>
                        <YumComputer/>
                    </Box>}
                </Box>
                <Box flex={2}>
                ...
                <Box flex={1} sx={{ position: 'relative', display: largerThanSM ? 'inline-block' : 'none'}}>
                    <Box sx={{ position: 'absolute', top: '10%', right: largerThanMD ? 30 : 0, width: '60%', maxWidth: 280 }}>
                        <Pencil />
                    </Box>
                    <Box sx={{ position: 'absolute', bottom: extra ? '30%' : 0, right: largerThanMD ? 30 : 0, width: '60%', maxWidth: 280  }}>
                        <OkHands />
                    </Box>
                    {extra && <Box sx={{position: 'absolute', bottom: 0, right: largerThanMD ? 30 : 0, width: '70%', maxWidth: 280 }}>
                        <Eyes/>
                    </Box>}
                </Box>
            </Box>
